...
public class AuthController {
    ...
    public Map<String,Object> login(@RequestBody Map<String,String> body){
        ...
        try {
            ...
            // Return all user fields needed for account page
            return Map.of(
                "id",u.getId(),
                "email",u.getEmail(),
                "role",u.getRole(),
    ...
    public Map<String,Object> employeeLogin(@RequestBody Map<String,String> body){
        System.out.println("Employee login request: " + body);
        try {
            String email = body.get("email");
            String password = body.get("password");
            Optional<Employee> o = employeeRepo.findByEmail(email);
            if(o.isEmpty()) return Map.of("error","invalid credentials");
            Employee emp = o.get();
            // For now, check plain text password (should be encrypted in production)
            if(!password.equals(emp.getPassword())) return Map.of("error","invalid credentials");
